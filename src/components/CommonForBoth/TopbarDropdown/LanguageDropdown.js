...
class LanguageDropdown extends Component {
  ...
  changeLanguageAction = (lng) => {
    ...
    if (lng === "sp")
      ...
      this.setState({ lng: "Brazil", flag: brazil });
  }
      ...
      <React.Fragment>
        <Dropdown isOpen={this.state.menu} toggle={this.toggle} className="d-none d-sm-inline-block">
          {/* <DropdownToggle tag="button" className="btn header-item waves-effect">
            <img className="" src={this.state.flag} alt="Idioma" height="16" />
          </DropdownToggle> */}
          ...
          <DropdownMenu className="dropdown-menu-end">
            ...
            <DropdownItem active={this.state.lng === "Brazil" ? true : false} href="" onClick={() => this.changeLanguageAction('br')} className="notify-item">
              <img src={brazil} alt="user" className="me-1" height="12" /> <span className="align-middle">Brasil</span>
            </DropdownItem>
