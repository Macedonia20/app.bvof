                    ...
                    <ul className="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <Link to="/atividades">
                                ...
                                <span className="ms-1">COMANDOS</span>
                            </Link>
                        </li>
                        ...
                        <li>
                            <Link to="/eventos">
                                ...
                                <span className="ms-1">EVENTOS</span>
                            </Link>
                        </li>

                        <li>
                            <Link to="/mensagens-putz">
                                <i className="ri-book-read-fill"></i>
                                <span className="ms-1">MENSAGENS PUTZZZ</span>
                            </Link>
                        </li>
                        ...
                        <li>
                            <Link to="/missoes">
                                ...
                                <span className="ms-1">MISSÕES</span>
                            </Link>
                        </li>
                        ...
                        <li>
                            <Link to="/niveis">
                                ...
                                <span className="ms-1">NÍVEIS</span>
                            </Link>
                        </li>
                        ...
                        {/* <li>
                            <Link to="/faqs">
                                ...
                                <span className="ms-1">{this.props.t('FAQs')}</span>
                            </Link>
                        </li>

                        <li>
                            <Link to="canal-de-denuncia">
                                <i className="ri-spam-fill"></i>
                                <span className="ms-1">Canal de denúncia</span>
                            </Link>
                        </li> */}
