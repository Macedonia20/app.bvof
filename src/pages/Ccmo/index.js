...
class coletaCelula extends Component {
  constructor(props) {
    super(props)
    this.state = {
      breadcrumbItems: [
  ...
  async controlarModalEdicao(idItem) {
    ...
    .then(({ data })=> {
      ...
      setTimeout(() => {
        ...
        this.setState({ temposcirurgicos: data.temposcirurgicos });
        ...
        this.setState({ cuidadosaposcoleta: data.cuidadosaposcoleta });
      ...
      <React.Fragment>
          ...
          >
            ...
            <ModalBody>
              ...
              {this.state.temposcirurgicos ? (<>
                <Row className="mb-3">
                  <Label className="form-label">Tempos cirúrgicos : <span style={{ fontWeight: 300 }}>{this.format(this.state.temposcirurgicos)}</span></Label>
                </Row>
              </>) : (<></>)}
              
              {this.state.conservacaotransporte ? (<>
                <Row className="mb-3">
                  <Label className="form-label">Conservacao Transporte: <span style={{ fontWeight: 300 }}>{this.format(this.state.conservacaotransporte)}</span></Label>
                </Row>
              </>) : (<></>)}
              ...
              {this.state.cuidadosaposcoleta ? (<>
                <Row className="mb-3">
                  <Label className="form-label">Cuidados após a coleta: <span style={{ fontWeight: 300 }}>{this.format(this.state.cuidadosaposcoleta)}</span></Label>
                </Row>
              </>) : (<></>)}
