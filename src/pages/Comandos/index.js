...
class Comandos extends Component {
    constructor(props) {
        super(props);
        this.state={
            breadcrumbItems : [],
    ...
    async carregarVideos () {
        try {
            ...
            await api.get(`/videos?tipo=comando&categoria=sugestaodasemana`, options)
              .then(({ data })=> {
                this.setState({
                  isLoading: false
                });
        ...
        return (
            <React.Fragment>
                ...
                <div className="page-content">
                    <Container fluid>
                        <Breadcrumbs title="Sugestões da semana" breadcrumbItems={this.state.breadcrumbItems} />
