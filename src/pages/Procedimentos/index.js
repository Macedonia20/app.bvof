...
class Procedimentos extends Component {
  ...
  async controlarModalEdicao(idItem) {
    ...
    .then(({ data })=> {
      ...
      setTimeout(() => {
        ...
        this.setValueId('materiais', data.materiais);
  ...
  getObjetoItem() {
    const item = {
      ...
      materiais: this.getValueId('materiais'),
  ...
  render() {
    ...
    const columns = [{
      ...
      formatter: (cellContent, row) => (
        <React.Fragment>
          <Link to="#" onClick={() => this.controlarModalEdicao(row.idprocedimentos)} className="me-3 text-primary"><i className="mdi mdi-pencil font-size-18"></i></Link>
          <Link to="#" onClick={() => this.apagarItem(row.idprocedimentos)} className="text-danger"><i className="mdi mdi-trash-can font-size-18"></i></Link>
        </React.Fragment>
      ),
    }];
      ...
      <React.Fragment>
        ...
        >
          ...
          <ModalBody>
            ...
            <Row className="mb-3">
                <Label className="col-md-2 col-form-label">materiais</Label>
                <Col md={10}>
                    <Input id="materiais" type="text"/>
                </Col>
            </Row>
            <Row className="mb-3">
